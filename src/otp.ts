...
export const totpIssuer = process.env.TOTP_ISSUER || 'Decentralized Creator';
export const totpLabel = process.env.TOTP_LABEL || 'Decentralized Creator';
export const totpSecret = process.env.TOTP_SECRET || 'DCREATOR';
